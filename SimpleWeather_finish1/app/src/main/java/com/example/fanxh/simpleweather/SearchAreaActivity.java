    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            if (!TextUtils.isEmpty(weatherId)) {
                ...
                try {
                    cursor = db.query("Information", null, "county_name = ?", new String[]{countyName}, null, null, null);
                    if (cursor != null) {
                        if (cursor.moveToFirst()) {
//                            showAllWeather();
                            Toast.makeText(SearchAreaActivity.this,"该城市已在收藏列",Toast.LENGTH_SHORT).show();
                        } else {
//                            showAllWeather();
                            showProgressDialog();

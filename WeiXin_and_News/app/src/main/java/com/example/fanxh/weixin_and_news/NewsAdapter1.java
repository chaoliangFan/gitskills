...
public class NewsAdapter1 extends ArrayAdapter {
    ...
    public NewsAdapter1(@NonNull Context context, int textViewResourceId, @NonNull List objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        newsDetailsText.setText(newsData.getDetails());
        return view;
    }
